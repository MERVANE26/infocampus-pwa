  ...
  <div className={styles.tabContent}>
    ...
    <Form onSubmit={onSubmit} className={styles.form}>
      ...
      <div className={styles.formSection}>
        ...
        <Form.Group className="mb-3">
          <Form.Label className={styles.label}>
            <FaEnvelope className={styles.inputIcon} /> mot de passe <span className={styles.required}>*</span>
          </Form.Label>
          <Form.Control
            type="password"
      ...
      <div className={styles.formSection}>
        ...
        <Form.Group className="mb-3">
          ...
          >
            <option value="universite-douala">université douala</option>
            <option value="universite-yaounde">université yaoundé</option>
            <option value="universite-bamenda">université bamenda</option>
            <option value="universite-maroua">université maroua</option>
            <option value="universite-iug">université iug</option>
          </Form.Select>
          <Form.Control.Feedback type="invalid">
            {errors.universityId}
          </Form.Control.Feedback>
